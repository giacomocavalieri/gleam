...
fn module_document<'a>(
    ...
    for custom_type in &module.definitions.custom_types {
        register_imports_for_custom_type(
            custom_type,
            &mut type_exports,
            &mut type_defs,
            &module.name,
...
fn register_imports_for_custom_type(
    ...
    let phantom_vars = type_var_usages
        .keys()
...
fn register_exports_for_function(
